...
function EmployerInterviews() {
    ...
    return (
        <Container fluid>
                                ...
                                <tbody>
                                    {applications.map(application => (
                                        <tr key={application.ID}>
                                            ...
                                            <td>
                                                <Button onClick={() => decide(application)} disabled={!beforeToday(application.Interview)}>
                                                    Decide
                                                </Button>
                                            </td>
                                        </tr>
            ...
            <HireEmployee show={showHire} onHide={() => setShowHire(false)} application={application} close={setShowHire} />
        </Container>
    )
}
